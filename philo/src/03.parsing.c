...
/*   Updated: 2025/01/26 22:12:48 by umeneses         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	table_parsing(t_table *table, char **av)
{
	...
	table->time_to_die = ft_atoi_long(av[2]) * 1e3;
	table->time_to_eat = ft_atoi_long(av[3]) * 1e3;
	table->time_to_sleep = ft_atoi_long(av[4]) * 1e3;
	if (av[5])
